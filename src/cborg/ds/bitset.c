...
size_t cb_ds_bitset_size(bitset_t *bs) { return bs->size; }
...
bool cb_ds_bitset_none(bitset_t *bs) { return !(cb_ds_bitset_any(bs)); }
...
bitset_t *cb_ds_bitset_read(const char *path) {
  ...
  bitset_t *bs = cb_ds_bitset_new(size);
